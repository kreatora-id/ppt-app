                ...
                <div class="row mb-2">
                    <div class="col-lg-9 mb-5">
                        <div class="icon-box">
                            ...
                            @endif
                            <button class="kr-btn-outline-primary w-100 fontSize18" style="text-wrap: pretty;">
                                Dapatkan template {{ $detail->price ? 'hanya ' . Helper::numberToCurrency($detail->price) : 'gratis'}}
                            </button>
                            <div class="my-5">
                                {!! $detail->description !!}
                            </div>
